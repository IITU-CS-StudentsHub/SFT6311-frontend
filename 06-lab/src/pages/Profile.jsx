      ...
      <div className="profile-details">
        <section style={{ marginBottom: '30px' }}>
          ...
          <p style={{ color: 'var(--text-secondary)', lineHeight: '1.6' }}>
            Passionate software engineer with a focus on self-hosted
            infrastructure and automation. Currently studying at IITU and
            building the own ecosystem. I love orchestrating containers,
            managing servers, and optimizing workflows ;)
          </p>
        </section>
